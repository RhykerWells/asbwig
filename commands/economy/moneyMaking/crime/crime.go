...
var Command = &dcommand.AsbwigCommand{
	...
	Run: func(data *dcommand.Data) {
		...
		userCrime, err := models.EconomyCooldowns(qm.Where("guild_id = ? AND user_id = ? AND type = 'crime'", data.Message.GuildID, data.Message.Author.ID)).One(context.Background(), common.PQ)
		if err == nil {
